defmodule WeatherScout.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, WeatherScout.Repo)
  ...
  """
  def valid_password?(%WeatherScout.Accounts.User{hashed_password: hashed_password}, password)
