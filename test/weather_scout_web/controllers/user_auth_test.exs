defmodule WeatherScoutWeb.UserAuthTest do
  use WeatherScoutWeb.ConnCase, async: true

  alias WeatherScout.Accounts
  alias WeatherScoutWeb.UserAuth
  import WeatherScout.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, WeatherScoutWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      WeatherScoutWeb.Endpoint.subscribe(live_socket_id)
